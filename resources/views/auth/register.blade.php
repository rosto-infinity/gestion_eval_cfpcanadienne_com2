                ...
                <div class="p-6 sm:p-8">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <x-text-input 
                                id="name" 
                                class="block w-full px-4 py-1 rounded-md border border-gray-300 dark:border-[#3E3E3A] bg-white dark:bg-[#1e1e1d] text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all duration-200 shadow-sm"
                                type="text" 
                                name="name" 
                                :value="old('name')" 
                                required 
                        ...
                        {{-- <div class="flex items-start mb-3">
                            <div class="relative">
                                ...
                                <div class="w-4 h-4 flex items-center justify-center rounded border border-gray-300 dark:border-[#3E3E3A] bg-white dark:bg-[#1e1e1d] peer-checked:border-primary peer-checked:bg-primary transition-all duration-200">
                            ...
                            <label for="terms" class="ms-2 text-sm text-gray-700 dark:text-gray-300">
                                J'accepte les <a href="#" class="text-primary hover:text-primary/80 font-medium underline">conditions d'utilisation</a>
                            </label>
                        </div> --}}

                        <!-- Submit Button & Login Link -->
                        <div class="space-y-4">
                            <x-primary-button class="w-full bg-primary hover:bg-primary/90 text-white font-medium py-3 px-4 rounded-md shadow-[0_2px_4px_0_rgba(121,23,249,0.25)] transition-all duration-200 flex items-center justify-center gap-2">
                            ...
                            <div class="text-center text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <a href="{{ route('login') }}" class="font-medium text-primary hover:text-primary/80 ms-1 transition-colors duration-200">
                                    {{ __('Connectez-vous') }}
                                </a>
                            </div>
                        </div>
