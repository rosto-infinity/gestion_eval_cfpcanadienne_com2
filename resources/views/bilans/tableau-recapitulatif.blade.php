...
<div class=" mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex items-center justify-between mb-6 no-print">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('bilans.tableau-recapitulatif.export-pdf', request()->all()) }}" class="px-3 py-2 text-xs font-medium text-primary-foreground bg-primary hover:bg-primary/90 rounded transition-colors inline-flex items-center gap-1">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
