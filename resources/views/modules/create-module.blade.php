...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-gray-700">Ajouter un nouveau module d'enseignement</p>
    </div>

    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <form action="{{ route('modules.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Format: M1 à M5 (Semestre 1), M6 à M10 (Semestre 2)</p>
                </div>
...
Même structure que create.blade.php mais avec:
