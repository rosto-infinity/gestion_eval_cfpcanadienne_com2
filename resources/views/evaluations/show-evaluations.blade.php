...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-foreground"><i class='bx bx-bar-chart-alt-2'></i> Détails de l'Évaluation</h1>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-xl p-5">
                <div class="flex items-start gap-2">
                    ...
                    <div>
                        <h3 class="text-xs font-bold text-blue-900 dark:text-blue-100 uppercase tracking-wide mb-2"><i class='bx bx-bulb'></i> Actions</h3>
