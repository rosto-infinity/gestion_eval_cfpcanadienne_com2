                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-border bg-muted/30">
                            <th class="px-6 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide">Étudiant</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide">Module</th>
                            <th class="px-6 py-3 text-center text-xs font-semibold text-muted-foreground uppercase tracking-wide">Semestre</th>
                            <th class="px-6 py-3 text-center text-xs font-semibold text-muted-foreground uppercase tracking-wide">Note</th>
                            <th class="px-6 py-3 text-center text-xs font-semibold text-muted-foreground uppercase tracking-wide">Appréciation</th>
                            ...
                            <tr class="hover:bg-muted/30 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="flex-shrink-0">
                                            ...
                                            @else
                                                <div class="h-8 w-8 rounded-full bg-gradient-to-br from-primary/40 to-primary/20 flex items-center justify-center text-xs font-bold text-primary border border-primary/20">
                                                    {{ $evaluation->user->initials() }}
                                                </div>
                                            @endif
                                        </div>
                                        <div>
                                            <div class="text-sm font-semibold text-foreground">{{ $evaluation->user->getFullName() }}</div>
                                            <div class="text-xs text-muted-foreground">{{ $evaluation->user->matricule }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div>
                                        ...
                                        <div class="text-sm text-muted-foreground mt-1">{{ $evaluation->module->intitule }}</div>
                                    </div>
                                </td>

                                <!-- Semestre -->
                                <td class="px-6 py-4 text-center">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold {{ $evaluation->semestre == 1 ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700' }}">
