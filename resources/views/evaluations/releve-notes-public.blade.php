...
@section('title', 'Vérification de Relevé de Notes | CFP La Canadienne')

@section('content')
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        
        <!-- Verification Success Banner -->
        <div class="mb-6 p-4 bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-800/30 rounded-xl flex items-center gap-3">
            ...
            <div>
                <h4 class="font-bold text-emerald-800 dark:text-emerald-300 text-sm">Document Officiel Vérifié</h4>
                <p class="text-xs text-emerald-600 dark:text-emerald-400">Ce relevé de notes est certifié et provient directement du système d'information du CFP La Canadienne.</p>
            </div>
        </div>
        ...
        <div class="mb-4 flex justify-between items-center no-print">
            ...
            <div class="flex gap-2">
                <a href="{{ route('evaluations.releve-notes.public.pdf', ['token' => $token]) }}" target="_blank" class="inline-block">
                    <button
