...
<head>
    ...
    <title>Page Non Trouvée - 404 | CFPC</title>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-300 mb-4">Page Non Trouvée</h2>
            ...
            <div class="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <div class="text-xs text-blue-800 dark:text-blue-200 space-y-1">
                    <p><strong>Application:</strong> CFPC Gestion des Évaluations</p>
                    <p><strong>Version:</strong> 1.0.0</p>
                    <p><strong>Date:</strong> {{ now()->format('d/m/Y H:i') }}</p>
                    <p><strong>Support:</strong> contact@cfpcanadienne.com</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="col-span-1">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="/login" class="text-gray-300 hover:text-white text-sm transition-colors">
                                Connexion
                            </a>
                        </li>
                        <li>
